...
import mc.sbm.operaconductor.repository.event.MergeProfileEventRepository;
import org.springframework.stereotype.Component;
import org.springframework.transaction.annotation.Transactional;

@Component
@RequiredArgsConstructor
public class ProfileMergeProfileMapper implements SinkMapper<ProfileDto> {

    private final MergeProfileEventRepository repository;

    @Override
    public String eventKey() {
        return "PROFILE_MERGE_PROFILE";
    }
    ...
    public void sink(ProfileDto dto) {
        MergeProfileEvent entity = MergeProfileEvent.builder()
            .primaryKey(dto.getPrimaryKey())
            .hotelId(dto.getHotelId())
            .moduleName("Profile")
            .eventName("MERGE PROFILE")
