...
public class CashieringUpdatePostingMapper implements SinkMapper<FinancialTransactionDto> {

    private final CashieringPostingEventRepository repository;

    @Override
    public String eventKey() {
        return "CASHIERING_UPDATE_POSTING";
    }
    ...
    public void sink(FinancialTransactionDto dto) {
        repository.save(FinancialTransactionMapper.toEntity(dto, "UPDATE POSTING"));
    }
}
